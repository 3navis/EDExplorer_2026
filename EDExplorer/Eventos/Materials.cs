...
namespace EDExplorer
{
    ...
    public static class MineralLookup
    {
        private static readonly Dictionary<string, int> MineralDict = Enum.GetValues(typeof(Minerales)).Cast<Minerales>().ToDictionary(mine => mine.ToString().ToLower(), mine => (int)mine);

        public static int ByName(string mineralName)
        {
            return MineralDict[mineralName];
        }
    }
