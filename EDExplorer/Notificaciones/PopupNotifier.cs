            ...
            if (!disposed)
            {
                if (!frmPopup.Visible)
                {
                    ...
                    if (Scroll)
                    {
                        ...
                        //posStart = Screen.GetWorkingArea(frmPopup).Bottom;
                        //posStop = Screen.GetWorkingArea(frmPopup).Bottom - frmPopup.Height;
                    ...
                    else
                    {
                        ...
                        posStop = Screen.PrimaryScreen.WorkingArea.Bottom - frmPopup.Height;
                        //posStart = Screen.GetWorkingArea(frmPopup).Bottom - frmPopup.Height;
                        //posStop = Screen.GetWorkingArea(frmPopup).Bottom - frmPopup.Height;
                    }
                    opacityStart = 0;
                    opacityStop = 1;
                    ...
                    //frmPopup.Location = new Point(Screen.GetWorkingArea(frmPopup).Right - frmPopup.Size.Width - 1, posStart);
                    frmPopup.Show();
                    isAppearing = true;
